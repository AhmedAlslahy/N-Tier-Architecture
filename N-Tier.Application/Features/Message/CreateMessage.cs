...
{
    public sealed class CreateMessageReq
    {
    ...
    public sealed class Validator : AbstractValidator<CreateMessageReq>
    {
        public Validator()
        {
    ...
    public sealed class CreateMessageHandler(SarhneDbContext context, IHubContext<NotificationHub> hubContext)
    {
        public async Task<Result> Handle(CreateMessageReq req, int userId, CancellationToken cancellation = default)
        {
            //create Message
